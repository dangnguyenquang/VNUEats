...
//     try {
//       const res = await client.get(`${ordersEndpoint.getOrder}?status=${status}&page=${page}`)
//       return res
//     } catch (error) {
//       console.error(error)
...
//     try {
//       const res = await client.post(ordersEndpoint.postEvaluation, {
//         idOrder,
//         comment,
//         listFood,
//       })
...
//     try {
//       const res = await client.patch(ordersEndpoint.cancelOrder, { idOrder })
//       return res
//     } catch (error) {
