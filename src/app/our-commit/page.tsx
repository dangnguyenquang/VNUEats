  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Yummy cam kết mang đến món ăn chất lượng, giá cả hợp lý và giao hàng nhanh chóng." />
        <meta name="keywords" content="Yummy, đặt món ăn, giao hàng nhanh, thực phẩm chất lượng" />
        ...
        <div>
          ...
          <div className='max-w-[1150px]'>
            <p className='text-[20px] font-light'>
              Tại Yummy, chúng tôi cam kết mang đến trải nghiệm đặt món tốt nhất với chất lượng đảm bảo, giá cả hợp lý và giao hàng nhanh chóng.
            </p>
            <ol className='list-decimal pl-5'>
              <li className='mt-5 text-[20px] font-bold'>
                <h2>Chất Lượng Món Ăn</h2>
                <p className='font-light'>
                  Món ăn được chọn từ các nhà hàng uy tín, đảm bảo vệ sinh an toàn thực phẩm.
                </p>
              ...
              <li className='mt-5 text-[20px] font-bold'>
                ...
                <ul className='list-disc pl-10'>
                  <li className='font-light'>Hợp tác với các đối tác giao hàng chuyên nghiệp.</li>
                  <li className='font-light'>Món ăn đến tay khách hàng đúng thời gian cam kết.</li>
                </ul>
              </li>
            </ol>
            <p className='text-center mt-10 text-[25px] font-bold'>
              Với tất cả những cam kết trên, <strong className='text-secondary text-[30px]'>Yummy</strong> luôn là lựa chọn đáng tin cậy cho bữa ăn của bạn!
            </p>
          </div>
        </div>
      </section>
