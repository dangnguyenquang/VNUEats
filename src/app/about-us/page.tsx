        ...
        <div className="w-full" style={{ minWidth: '410px' }}>
                            ...
                            <div className="mt-[30px] text-center">
                                <p className={`${styleTextDesc}`}>
                                    ...
                                    <strong className="font-bold">
                                        một nhóm sinh viên tại Trường Đại học Công nghệ
                                        thông tin - ĐHQG TPHCM
                                    </strong>
                                </p>
                                <p className={`${styleTextDesc}`}>
                                    <strong className="font-bold text-[40px] text-secondary">
                                        Yummy
                                    </strong>{' '}
                                    là cộng đồng tin cậy cho mọi người có thể tìm kiếm,
                                    đánh giá và đặt món ăn từ các địa điểm ăn uống: nhà
                                    hàng, quán ăn,..... tại thành phố Hồ Chí Minh. Từ đó
                                    kết nối những thực khách đến với các địa điểm ăn uống
                                    lớn nhỏ cả đất nước.
                                </p>
                            </div>
                        </div>
            ...
            <div className=" mt-[70px] px-[20px] sm:px-[40px] lg:px-[70px]">
                <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
                    ...
                    <div
                        ...
                        data-aos="fade-left"
                    >
                        “Chúng tôi - những con người cùng với những ngọn lửa đam mê cháy
                        bỏng dành cho công nghệ, đang không ngừng nỗ lực trau dồi và hoàn
                        thiện bản thân hơn để mang đến những sản phẩm vượt trội và tạo ra
                        những trải nghiệm tuyệt vời nhất cho mọi người.”
                    </div>
                </div>
                    ...
                    <div className="absolute inset-0 flex justify-center bg-black bg-opacity-50 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 ml-[50px]">
                                <div className={`${styleTextDesc} font-light`}>
                                    1. Nguyễn Quang Đăng
                                </div>
                                <div className={`${styleTextDesc} font-light`}>
                                    MSSV: 22520191
            ...
            <div className=" p-[20px] lg:p-[70px] flex relative flex-col lg:flex-row justify-center">
                ...
                >
                    ...
                    <div
                        className={`font-light ${styleTextDesc} mt-[30px] max-lg:text-center`}
                    >
                        Yummy cam kết mang đến cho khách hàng trải nghiệm ẩm thực đa dạng
                        và tiện lợi thông qua nền tảng đặt món ăn trực tuyến hiện đại.{' '}
                        <br />
                        Chúng tôi kết nối những nhà hàng hàng đầu với thực khách, đảm bảo
                        mỗi bữa ăn đều tươi ngon, an toàn và được giao tận nơi một cách
                        nhanh chóng. Với Yummy, việc thưởng thức ẩm thực trở nên dễ dàng,
                        chỉ cần vài cú click là bạn đã có ngay bữa ăn yêu thích tại nhà.
                    </div>
                    <button
                ...
                <div className="flex flex-wrap justify-center gap-[5vw] ">
                    {Items.map((item, index) => (
                        ...
                        >
                            ...
                            />
                            <div
                                className={`mt-[12px] text-center font-bold ${styleTextDesc}`}
                            >
                                {item.title}
                            </div>
