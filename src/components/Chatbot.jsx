                    ...
                    >
                        <div className={`text-left max-w-[92%] mb-2`}>
                            ...
                            >
                                ...
                                <strong className='text-secondary'>Yummy</strong>, mình
                                sẵn sàng trả lời bất kì câu hỏi nào của bạn ^_^!
                            </span>
                        </div>
                        ...
                        {isBotTyping && (
                            <div className={`text-left max-w-[92%]`}>
                                <span
                                    className={`inline-block rounded-2xl bg-gray-200 text-black`}
                                >
                                    <Typing />
                                </span>
                            </div>
